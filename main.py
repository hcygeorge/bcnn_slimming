...
if __name__ == '__main__':
    print('Batch: {}, LR: {}, Sparsity: {}, Penalty: {}, Patience: {}'.format(
        batch_size, lr, channel_sparsity, sparsity_rate, patience))
    #%%
    # Seed
    # random.seed()
...
if __name__ == '__main__':
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='max',
                                                           factor=0.1, patience=patience, verbose=True, threshold=1e-4, min_lr=1e-6)
